  ...
  const majorAchievements = [
    {
      ...
      description: "3-е место - наши самые младшие воспитанники показали отличную игру"
    },
    {
      year: "2025",
      title: "Кубок посвящённый «Дню победы» до 16 лет",
      description: "2-е место - достойное выступление в престижном турнире"
    },
    {
      year: "2025", 
      title: "Первенство Приморского края среди 2013 года рождения",
      description: "2-е место - серебряные призёры краевого первенства"
    },
    {
      year: "2024",
      title: "Первенство МБУ СШ «Богатырь» г. Владивосток среди 2009 г.р.",
      description: "1-е место - золотые медали в городских соревнованиях"
    },
    {
      year: "2024",
    ...
    },
    {
      ...
      description: "3-е место - бронзовые медали в возрастной категории"
    }
  ];
          ...
          <Card className="max-w-2xl mx-auto border-viking-orange/20 card-gradient">
            <CardContent className="p-6 md:p-8">
              ...
              <p className="text-gray-600 mb-6">
                Присоединяйтесь к баскетбольной школе "Викинги" и помогите нам писать новые страницы побед
              </p>
              <button 
                onClick={() => {
